            ...
            <ul class="list-group mb-3">
                @foreach ($cartData as $value)
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0">Product name: {{$value['name']}}</h6>
                            <small class="text-muted">Quentity: {{$value['quantity']}}</small>
                        </div>
                        {{-- <span class="text-muted">{{$value['id'] }}</span> --}}
                        <span class="text-muted">{{Cart::get($value['id'])->getPriceSum() }}</span>
                    </li>
                @endforeach
                ...
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <strong>{{Cart::getTotal()+50}} TK</strong>
                </li>
            </ul>
        </div>
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="zip" value="zip" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
